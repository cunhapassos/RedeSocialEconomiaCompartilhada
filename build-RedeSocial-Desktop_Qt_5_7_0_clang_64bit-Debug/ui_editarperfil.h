...
#ifndef UI_EDITARPERFIL_H
#define UI_EDITARPERFIL_H
...
public:
    ...
    void setupUi(QDialog *EditarPerfil)
    {
        ...
        EditarPerfil->resize(605, 311);
        groupBox = new QGroupBox(EditarPerfil);
        ...
        lineEditNome->raise();
        layoutWidget->raise();
        groupBox_3 = new QGroupBox(EditarPerfil);
    ...
    {
        EditarPerfil->setWindowTitle(QApplication::translate("EditarPerfil", "Editar Perfil do Usu\303\241rio", 0));
        groupBox->setTitle(QApplication::translate("EditarPerfil", "Dados Pessoais", 0));
        label_5->setText(QApplication::translate("EditarPerfil", "CEP:", 0));
        groupBox_2->setTitle(QApplication::translate("EditarPerfil", "G\303\252nero:", 0));
        radioButtonM->setText(QApplication::translate("EditarPerfil", "M", 0));
        radioButtonF->setText(QApplication::translate("EditarPerfil", "F", 0));
        label->setText(QApplication::translate("EditarPerfil", "Nome:", 0));
        label_3->setText(QApplication::translate("EditarPerfil", "Idade:", 0));
        label_4->setText(QApplication::translate("EditarPerfil", "Escolaridade:", 0));
        groupBox_3->setTitle(QApplication::translate("EditarPerfil", "Interesses", 0));
        pushButton_3->setText(QApplication::translate("EditarPerfil", "Remover", 0));
        pushButton_2->setText(QApplication::translate("EditarPerfil", "Adicionar", 0));
        pushButtonAdicionar->setText(QApplication::translate("EditarPerfil", "Concluir", 0));
        pushButton_4->setText(QApplication::translate("EditarPerfil", "Cancelar", 0));
    } // retranslateUi
